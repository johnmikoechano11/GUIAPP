 ...
 * @author Angie
 */
public class workoutPlan_page extends javax.swing.JInternalFrame {

    /**
     * Creates new form workoutPlan_page
     */
    public workoutPlan_page() {
        initComponents();
    ...
    workout_table.setRowHeight(30);
    workout_table.setShowGrid(false);
    workout_table.setIntercellSpacing(new java.awt.Dimension(0,0));
    workout_table.setBackground(Color.WHITE);
    workout_table.setBorder(null);


    workout_table.getTableHeader().setOpaque(false);
    workout_table.getTableHeader().setPreferredSize(new java.awt.Dimension(100, 35));

workout_table.getTableHeader().setDefaultRenderer(new DefaultTableCellRenderer() {
    @Override
...
workout_table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
    @Override
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
...
jScrollPane1.getViewport().setBackground(Color.WHITE);
    ...
    cc.displayData("SELECT wp_id as 'ID', plan_name as 'Plan Name', "
                 + "duration as 'Duration', goal as 'Goal', intensity as 'Intensity', "
                 + "trainer as 'Trainer', status as 'Status' FROM workout_plans", workout_table);
}
    ...
    private void initComponents() {
        ...
        workout_table = new javax.swing.JTable();
        ...
        workout_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(workout_table);
    ...
    private void searchUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchUserMouseClicked
       ...
       String query = "SELECT wp_id as 'ID', plan_name as 'Plan Name', "
    + "duration as 'Duration', goal as 'Goal', intensity as 'Intensity', "
    + "trainer as 'Trainer', status as 'Status' FROM workout_plans "
    + "WHERE UPPER(plan_name) LIKE UPPER('%" + txt + "%') "
    + "OR UPPER(trainer) LIKE UPPER('%" + txt + "%')";

        conf.displayData(query, workout_table);
    ...
    private void AddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddMouseClicked
        ...
        mainFrame.dispose();
        workoutForm stf = new workoutForm();
        stf.setVisible(true);
        stf.action = "Add";
    ...
    int rowIndex = workout_table.getSelectedRow();
    if(rowIndex < 0){
        JOptionPane.showMessageDialog(null, "Please Select an Item!");
    } else {
        TableModel model = workout_table.getModel();
        workoutForm stf = new workoutForm();
        ...
        stf.Trainer.setText(model.getValueAt(rowIndex, 5).toString());
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        if(rowIndex < 0){
            ...
            if(a == JOptionPane.YES_OPTION){
                ...
                dbc.deleteData(u_id, "workout_plans", "wp_id");
                displayData();
            }
        }
    ...
    private javax.swing.JTable workout_table;
